export default {
  'touren-fuer-jugendliche': {
    'grosse-baumeister': {
      ...
      img: {
        src: 'ap2024-tour-23.jpg',
        alt: 'Mann der altertümlich Holz bearbeitet',
      },
      termine: {
    ...
    'die-wachsende-stadt': {
      ...
      img: {
        src: 'ap2024-hafencity-06.jpg',
        alt: 'Hamburger Hafencity mit neuen Gebäuden hinter großen Segelschiffen',
      },
      termine: {
  ...
  'touren-fuer-kinder-und-familien': {
    'speicherstadt-und-gewuerzmuseum': {
      ...
      img: {
        src: 'ap2024-tour-17.jpg',
        alt: 'Verschiedene Gewürze in Bechern mit Mörsern',
      },
      dauer: '1,5 Stunden',
    ...
    'klabautermanntour': {
      ...
      img: {
        src: 'ap2024-tour-01.jpg',
        alt: 'Schauspieler der wie ein Pirat verkleidet ist',
      },
      dauer: '1,5 Stunden',
      alter: '8-12 Jahre',
      kategorien: ['kt', 'ou'],
      termine: {
        '2024-06-11': ['11. Juni 15:00-16:30 Uhr', 'ausreichend Restplätze'],
      },
    },
    'gruseltour-mit-nachtwaechter': {
      ...
      img: {
        src: 'ap2024-tour-05.jpg',
        alt: 'Wächter vor einer Wand mit einer Waffe und einer Laterne. Sein Schatten fällt auf die Wand',
      },
      dauer: '1,5 Stunden',
    ...
    'sportliche-entdeckertour': {
      ...
      img: {
        src: 'ap2024-tour-07.jpg',
        alt: 'Mehrere Fahrradfahrer in der Hamburger Hafenstadt',
      },
      dauer: '2 Stunden',
      alter: '6-12 Jahre (nur in Begleitung Erwachsener)',
      kategorien: ['be', 'ou'],
      termine: {
        '2024-06-05': ['5. Juni 14:00 Uhr', 'ausreichend Restplätze'],
      },
    },
  },
  'kindergeburtstage': {
    ...
    'pfefferkoerner-und-verbrecherjagd': {
      name: 'Pfefferkörner & Verbrecherjagd',
    },
    'elbphilharmonie-entdecken': {
      name: 'Elbphilharmonie entdecken',
    },
  },
};
